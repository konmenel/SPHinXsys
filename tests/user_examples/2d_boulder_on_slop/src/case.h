 ...
 */
const Real DL = 2.0; 								/**< Tank length [m]. */
const Real DH = 0.5; 								/**< Tank height [m]. */
const Real wall_H = 0.2;							/**< Verical wall height [m] */
const Real wall_position = 1.8;						/**< Position of the verical wall [m] (x direction) */ 
const Real BL = 2.0e-2;								/**< Boulder lenght [m]. */
const Real BH = 1.5e-2;								/**< Boulder height [m]. */
const Real B_x = DL - 0.05;							/**< Boulder initial position x-axis (right edge) [m]. */
const Real B_y = wall_H + 0.01;						/**< Boulder initial position y-axis (right edge) [m]. */
